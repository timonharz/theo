...
class MNISTClassifier {
    ...
    class var urlOfModelInThisBundle : URL {
      let bundle = Bundle(for: self)
             //return try! MLModel.compileModel(at: URL(fileURLWithPath: "Resources/DiabetesPrediction.mlmodel"))
      return try! MLModel.compileModel(at: bundle.url(forResource: "MNISTClassifier", withExtension: "mlmodelc")!)
    }
    ...
    */
    @available(macOS 10.14, iOS 13.0, tvOS 12.0, watchOS 5.0, *)
    ...
    */
    ...
    func prediction(input: MNISTClassifierInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> MNISTClassifierOutput {
